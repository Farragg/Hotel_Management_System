                ...
                <div class="table-responsive">
                    ...
                    <form method="POST" action="{{ url('admin/room/' . $room->id) }}">
                        ...
                        <table class="table table-bordered" >
                                ...
                                <td>
                                    <select name="roomTypeId" class="form-control">
                                        ...
                                        @foreach($roomTypes as $roomType)
                                            <option @selected($room->room_type_id === $roomType->id) value="{{$roomType->id}}">{{ $roomType->title }}</option>
                                        @endforeach
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                <th> Title</th>
                                <td> <input value="{{ $room->title }}" name="title" type="text" class="form-control"></td>
                            </tr>
                            <tr>
