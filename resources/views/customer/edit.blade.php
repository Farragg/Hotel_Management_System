        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    @endif
                    <form method="POST" action="{{ url('admin/customer/' . $customer->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <table class="table table-bordered" >
                            ...
                            <tr>
                                <th>Email</th>
                                <td> <input value="{{ $customer->email }}" name="email" type="text" class="form-control"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" name="prev_img" value="{{$customer->photo}}">
                                    <img width="100" src="{{ $customer->image_path }}" style="width: 100px" class="img-thumbnail" alt=""/>
                                </td>
                            </tr>
                            <tr>
